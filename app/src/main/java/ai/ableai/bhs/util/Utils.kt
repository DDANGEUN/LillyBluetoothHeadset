...
class Utils {
    companion object{
        ...
        fun copyDataDir(dataDir: String): String {
            Log.i(ai.ableai.bhs.viewmodel.TAG, "data dir is $dataDir")
            copyAssets(dataDir)

            val newDataDir = MyApplication.applicationContext().getExternalFilesDir(null)!!.absolutePath
            Log.i(ai.ableai.bhs.viewmodel.TAG, "newDataDir: $newDataDir")
            return newDataDir
        }
        fun copyAssets(path: String) {
            ...
            try {
                ...
                Log.e(ai.ableai.bhs.viewmodel.TAG, "Failed to copy $path. $ex")
            }
        }
        fun copyFile(filename: String) {
            try {
                ...
                Log.e(ai.ableai.bhs.viewmodel.TAG, "Failed to copy $filename, $ex")
            }
        }
